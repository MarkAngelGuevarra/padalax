...
const BELT_LEVELS: BeltLevel[] = [
  {
    ...
    deliverables: ['scripts/level1_stellar_setup.js', 'Horizon RPC Integration', 'Payment Explorer Confirmation (Tx 7f82b338...)'],
  },
  {
    level: 2,
    ...
    status: 'Completed',
    description: 'Soroban Rust smart contract environment setup, workspace profile optimization, Multi-Wallet error handling, and WASM binary build.',
    deliverables: ['contracts/padalax_remit/Cargo.toml', 'Cargo.toml Root Workspace', 'WASM Optimization Profile'],
  },
  {
    level: 3,
    name: 'State Modeling, Token Escrow & Tests',
    belt: '🟠 Orange Belt',
    badgeColor: 'bg-amber-500/20 text-amber-300 border-amber-500/40',
    status: 'Completed',
    description: 'Persistent token escrow transfers, SHA-256 hashlock preimage verification, time-lock expirations, storage TTL management, and 6 unit tests.',
    deliverables: ['contracts/padalax_remit/src/lib.rs', 'contracts/padalax_remit/src/test.rs (6/6 Pass)', 'Event Publishing (TOPIC_REMIT)', 'Testnet Contract CATUXAJ7...'],
  },
  {
    level: 4,
    ...
    status: 'Upcoming',
    description: 'React + Vite Web3 PWA with Freighter wallet connection, dynamic deposit triggers, and real-time balance feeds (Pending Level 1-3 Review).',
